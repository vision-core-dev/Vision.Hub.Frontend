...
import { Badge } from "@/ui/base/badges/badges";
import { Checkbox } from "@/ui/base/checkbox/checkbox";
import { Dropdown } from "@/ui/base/dropdown/dropdown";
import { Tooltip, TooltipTrigger } from "@/ui/base/tooltip/tooltip";
...
const TableCardRoot = ({ children, className, size = "md", ...props }: HTMLAttributes<HTMLDivElement> & { size?: "sm" | "md" }) => {
    return (
        <TableContext.Provider value={{ size }}>
            <div {...props} className={cx("overflow-hidden w-full rounded-xl bg-primary shadow-xs ring-1 ring-secondary", className)}>
                {children}
            </div>
